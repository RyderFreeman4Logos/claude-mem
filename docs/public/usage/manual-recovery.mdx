...
- They're automatically reset to `pending` on worker startup and graceful shutdown
- Startup recovery and the 5-minute orphan scanner will retry them automatically
