...
| `CLAUDE_MEM_CONCURRENT_MESSAGES` | `3`                        | Global pending-message workers across and within sessions; summarize still waits behind earlier same-session observations (hot-reloads from `settings.json`, range `1-50`) |
